...
exports.processStatData = exports.processObjectStatus = exports.processObject = void 0;
    ...
    for (const stat of stats) {
        switch (stat.statType) {
            case models_1.StatType.NAME_STAT:
                ...
                continue;
            case models_1.StatType.LEVEL_STAT:
                playerData.level = stat.statValue;
                continue;
            case models_1.StatType.EXP_STAT:
                playerData.exp = stat.statValue;
                continue;
            case models_1.StatType.CURR_FAME_STAT:
                playerData.currentFame = stat.statValue;
                continue;
            case models_1.StatType.NUM_STARS_STAT:
                playerData.stars = stat.statValue;
                continue;
            case models_1.StatType.ACCOUNT_ID_STAT:
                playerData.accountId = stat.stringStatValue;
                continue;
            case models_1.StatType.FAME_STAT:
                playerData.accountFame = stat.statValue;
                continue;
            case models_1.StatType.CREDITS_STAT:
                playerData.gold = stat.statValue;
                continue;
            case models_1.StatType.MAX_HP_STAT:
                playerData.maxHP = stat.statValue;
                continue;
            case models_1.StatType.MAX_MP_STAT:
                playerData.maxMP = stat.statValue;
                continue;
            case models_1.StatType.HP_STAT:
                playerData.hp = stat.statValue;
                continue;
            case models_1.StatType.MP_STAT:
                playerData.mp = stat.statValue;
                continue;
            case models_1.StatType.ATTACK_STAT:
                playerData.atk = stat.statValue;
                continue;
            case models_1.StatType.ATTACK_BOOST_STAT:
                playerData.atkBoost = stat.statValue;
                continue;
            case models_1.StatType.DEFENSE_STAT:
                playerData.def = stat.statValue;
                continue;
            case models_1.StatType.DEFENSE_BOOST_STAT:
                playerData.defBoost = stat.statValue;
                continue;
            case models_1.StatType.SPEED_STAT:
                playerData.spd = stat.statValue;
                continue;
            case models_1.StatType.SPEED_BOOST_STAT:
                playerData.spdBoost = stat.statValue;
                continue;
            case models_1.StatType.DEXTERITY_STAT:
                playerData.dex = stat.statValue;
                continue;
            case models_1.StatType.DEXTERITY_BOOST_STAT:
                playerData.dexBoost = stat.statValue;
                continue;
            case models_1.StatType.VITALITY_STAT:
                playerData.vit = stat.statValue;
                continue;
            case models_1.StatType.VITALITY_BOOST_STAT:
                playerData.vitBoost = stat.statValue;
                continue;
            case models_1.StatType.CONDITION_STAT:
                playerData.condition = stat.statValue;
                continue;
            case models_1.StatType.WISDOM_STAT:
                playerData.wis = stat.statValue;
                continue;
            case models_1.StatType.WISDOM_BOOST_STAT:
                playerData.wisBoost = stat.statValue;
                continue;
            case models_1.StatType.HEALTH_POTION_STACK_STAT:
                playerData.hpPots = stat.statValue;
                continue;
            case models_1.StatType.MAGIC_POTION_STACK_STAT:
                playerData.mpPots = stat.statValue;
                continue;
            case models_1.StatType.HASBACKPACK_STAT:
                playerData.hasBackpack = stat.statValue === 1;
                continue;
            case models_1.StatType.NAME_CHOSEN_STAT:
                playerData.nameChosen = stat.statValue !== 0;
                continue;
            case models_1.StatType.GUILD_NAME_STAT:
                playerData.guildName = stat.stringStatValue;
                continue;
            case models_1.StatType.GUILD_RANK_STAT:
                playerData.guildRank = stat.statValue;
                continue;
            case models_1.StatType.SIZE_STAT:
                playerData.size = stat.statValue;
                continue;
            case models_1.StatType.NEXT_LEVEL_EXP_STAT:
                playerData.nextLevelExp = stat.statValue;
                continue;
            case models_1.StatType.TEX1_STAT:
                playerData.clothingDye = stat.statValue;
                continue;
            case models_1.StatType.TEX2_STAT:
                playerData.accessoryDye = stat.statValue;
                continue;
            case models_1.StatType.MAX_HP_BOOST_STAT:
                playerData.maxHPBoost = stat.statValue;
                continue;
            case models_1.StatType.MAX_MP_BOOST_STAT:
                playerData.maxMPBoost = stat.statValue;
                continue;
            case models_1.StatType.NEXT_CLASS_QUEST_FAME_STAT:
                playerData.nextClassQuestFame = stat.statValue;
                continue;
            case models_1.StatType.LEGENDARY_RANK_STAT:
                playerData.legendaryRank = stat.statValue;
                continue;
            case models_1.StatType.XP_BOOSTED_STAT:
                playerData.xpBoosted = stat.statValue === 1;
                continue;
            case models_1.StatType.XP_TIMER_STAT:
                playerData.xpBoostTime = stat.statValue;
                continue;
            case models_1.StatType.TEXTURE_STAT:
                playerData.texture = stat.statValue;
                continue;
            case models_1.StatType.FORTUNE_TOKEN_STAT:
                playerData.fortuneTokens = stat.statValue;
                continue;
            case models_1.StatType.PROJECTILE_SPEED_MULT:
                playerData.projSpeedMult = stat.statValue / 1000;
                continue;
            case models_1.StatType.PROJECTILE_LIFE_MULT:
                playerData.projLifeMult = stat.statValue / 1000;
                continue;
            case models_1.StatType.EXALTED_HP:
                playerData.exaltedHP = stat.statValue;
                continue;
            case models_1.StatType.EXALTED_MP:
                playerData.exaltedMP = stat.statValue;
                continue;
            case models_1.StatType.EXALTED_ATT:
                playerData.exaltedAtt = stat.statValue;
                continue;
            case models_1.StatType.EXALTED_DEF:
                playerData.exaltedDef = stat.statValue;
                continue;
            case models_1.StatType.EXALTED_SPEED:
                playerData.exaltedSpd = stat.statValue;
                continue;
            case models_1.StatType.EXALTED_DEX:
                playerData.exaltedDex = stat.statValue;
                continue;
            case models_1.StatType.EXALTED_VIT:
                playerData.exaltedVit = stat.statValue;
                continue;
            case models_1.StatType.EXALTED_WIS:
                playerData.exaltedWis = stat.statValue;
                continue;
            default:
                if (stat.statType >= models_1.StatType.INVENTORY_0_STAT && stat.statType <= models_1.StatType.INVENTORY_11_STAT) {
                    playerData.inventory[stat.statType - 8] = stat.statValue;
                }
                else if (stat.statType >= models_1.StatType.BACKPACK_0_STAT && stat.statType <= models_1.StatType.BACKPACK_7_STAT) {
